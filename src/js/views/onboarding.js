...
const PATHS = [
  {
    ...
    body: 'Your licence counts here only for a limited time after you move in. We\'ll track that legal ' +
          'deadline for you and walk you through converting it (Umschreibung) — usually far less work than starting over.',
    recommended: true,
  },
  {
  ...
  el.innerHTML = `
    <div class="onboard">
      ...
      <p class="center muted" style="font-size:.85rem;margin-top:12px;">
        Pick a path above to start. This app is a study and planning aid, not legal advice —
